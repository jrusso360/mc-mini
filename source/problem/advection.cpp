...
void ProblemStructure::frommMethod() {
  ...
  #ifdef DEBUG
    std::cout << "<Half-Time U-Offset Temperature Data>" << std::endl;
    std::cout << Map<Matrix<double, Dynamic, Dynamic, RowMajor> > (halfTimeUOffsetTemperatureData, M, (N - 1)) << std::endl << std::endl;
  #endif
  ...
  #ifdef DEBUG
    std::cout << "<Half-Time V-Offset Temperature Data>" << std::endl;
    std::cout << Map<Matrix<double, Dynamic, Dynamic, RowMajor> > (halfTimeVOffsetTemperatureData, (M - 1), N) << std::endl << std::endl;
  #endif
